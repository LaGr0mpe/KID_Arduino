...
#define VOLTAGE_MIN 3000  // 3.0V в мВ
#define VOLTAGE_MAX 4200  // 4.2V в мВ
#define VOLTAGE_DIVIDER_RATIO 2

// Светодиоды и периферия
#define LED_WHITE 5
#define LED_RED   4
...
// Время до сна при бездействии (в миллисекундах)
...
void handleButton() {
  ...
  if (lastButtonState == LOW && buttonState == HIGH) {
    ...
    // Короткое нажатие (всё кроме PAUSE/SETUP)
